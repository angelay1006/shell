...
void sigint_hand(int sig) { write(STDERR_FILENO, "SIGINT\n", 7); }

void sigtstp_hand(int sig) { write(STDERR_FILENO, "SIGTSTP\n", 8); }

void sigquit_hand(int sig) { write(STDERR_FILENO, "SIGQUIT\n", 8); }
